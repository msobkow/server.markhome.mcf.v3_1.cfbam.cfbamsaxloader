...
// Description: Java 25 XML SAX Element Handler for DbKeyHash512Type
...
/*
 *	CFBamSaxLoaderDbKeyHash512TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash512Type.
 */
public class CFBamSaxLoaderDbKeyHash512Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash512Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash512TypeObj origBuff = null;
		ICFBamDbKeyHash512TypeEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash512Type" );
			...
			origBuff = (ICFBamDbKeyHash512TypeObj)schemaObj.getDbKeyHash512TypeTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash512TypeEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash512TypeLoaderBehaviour();
			ICFBamDbKeyHash512TypeEditObj editDbKeyHash512Type = null;
			ICFBamDbKeyHash512TypeObj origDbKeyHash512Type = (ICFBamDbKeyHash512TypeObj)schemaObj.getDbKeyHash512TypeTableObj().readDbKeyHash512TypeByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash512Type == null ) {
				editDbKeyHash512Type = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash512Type = (ICFBamDbKeyHash512TypeEditObj)origDbKeyHash512Type.beginEdit();
						editDbKeyHash512Type.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash512Type.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash512Type.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash512Type.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash512Type.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash512Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash512Type.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash512Type.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash512Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash512Type.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash512Type.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash512Type.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash512Type = (ICFBamDbKeyHash512TypeEditObj)origDbKeyHash512Type.beginEdit();
						editDbKeyHash512Type.deleteInstance();
						editDbKeyHash512Type = null;
						origDbKeyHash512Type = null;
						editDbKeyHash512Type = editBuff;
						break;
				}
			}

			if( editDbKeyHash512Type != null ) {
				if( origDbKeyHash512Type != null ) {
					editDbKeyHash512Type.update();
				}
				else {
					origDbKeyHash512Type = (ICFBamDbKeyHash512TypeObj)editDbKeyHash512Type.create();
				}
				editDbKeyHash512Type = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash512Type );
		}
