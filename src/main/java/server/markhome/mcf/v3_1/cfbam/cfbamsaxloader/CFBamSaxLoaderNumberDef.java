...
// Description: Java 25 XML SAX Element Handler for NumberDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNumberDefObj origBuff = null;
		ICFBamNumberDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNumberDefObj)schemaObj.getNumberDefTableObj().newInstance();
			editBuff = (ICFBamNumberDefEditObj)origBuff.beginEdit();
			...
			ICFBamNumberDefObj origNumberDef = (ICFBamNumberDefObj)schemaObj.getNumberDefTableObj().readNumberDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origNumberDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNumberDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
