	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamMinorVersionObj origMinorVersion = (ICFBamMinorVersionObj)schemaObj.getMinorVersionTableObj().readMinorVersionByNameIdx( refParentMajVer.getRequiredId(),
