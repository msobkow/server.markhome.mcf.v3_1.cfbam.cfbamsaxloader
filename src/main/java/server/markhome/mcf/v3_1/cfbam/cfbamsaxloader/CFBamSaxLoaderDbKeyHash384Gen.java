...
// Description: Java 25 XML SAX Element Handler for DbKeyHash384Gen
...
/*
 *	CFBamSaxLoaderDbKeyHash384GenParse XML SAX Element Handler implementation
 *	for DbKeyHash384Gen.
 */
public class CFBamSaxLoaderDbKeyHash384Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash384Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash384GenObj origBuff = null;
		ICFBamDbKeyHash384GenEditObj editBuff = null;
		...
		// Atom References
		// DbKeyHash384Def Attributes
		String attrInitValue = null;
		// DbKeyHash384Def References
		// DbKeyHash384Type Attributes
		// DbKeyHash384Type References
		ICFBamSchemaDefObj refSchemaDef = null;
		// DbKeyHash384Gen Attributes
		String attrSlice = null;
		String attrBlockSize = null;
		// DbKeyHash384Gen References
		...
		try {
			assert qName.equals( "DbKeyHash384Gen" );
			...
			origBuff = (ICFBamDbKeyHash384GenObj)schemaObj.getDbKeyHash384GenTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash384GenEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash384GenLoaderBehaviour();
			ICFBamDbKeyHash384GenEditObj editDbKeyHash384Gen = null;
			ICFBamDbKeyHash384GenObj origDbKeyHash384Gen = (ICFBamDbKeyHash384GenObj)schemaObj.getDbKeyHash384GenTableObj().readDbKeyHash384GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash384Gen == null ) {
				editDbKeyHash384Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash384Gen = (ICFBamDbKeyHash384GenEditObj)origDbKeyHash384Gen.beginEdit();
						editDbKeyHash384Gen.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash384Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash384Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash384Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash384Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash384Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash384Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash384Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash384Gen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash384Gen.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash384Gen.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash384Gen.setRequiredSlice( editBuff.getRequiredSlice() );
						editDbKeyHash384Gen.setRequiredBlockSize( editBuff.getRequiredBlockSize() );
						editDbKeyHash384Gen.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash384Gen = (ICFBamDbKeyHash384GenEditObj)origDbKeyHash384Gen.beginEdit();
						editDbKeyHash384Gen.deleteInstance();
						editDbKeyHash384Gen = null;
						origDbKeyHash384Gen = null;
						editDbKeyHash384Gen = editBuff;
						break;
				}
			}

			if( editDbKeyHash384Gen != null ) {
				if( origDbKeyHash384Gen != null ) {
					editDbKeyHash384Gen.update();
				}
				else {
					origDbKeyHash384Gen = (ICFBamDbKeyHash384GenObj)editDbKeyHash384Gen.create();
				}
				editDbKeyHash384Gen = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash384Gen );
		}
