...
// Description: Java 25 XML SAX Element Handler for Int16Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt16TypeObj origBuff = null;
		ICFBamInt16TypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt16TypeObj)schemaObj.getInt16TypeTableObj().newInstance();
			editBuff = (ICFBamInt16TypeEditObj)origBuff.beginEdit();
			...
			ICFBamInt16TypeObj origInt16Type = (ICFBamInt16TypeObj)schemaObj.getInt16TypeTableObj().readInt16TypeByUNameIdx( refScope.getRequiredId(),
