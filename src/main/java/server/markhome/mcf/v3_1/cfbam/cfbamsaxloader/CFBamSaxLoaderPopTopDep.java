...
// Description: Java 25 XML SAX Element Handler for PopTopDep
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamPopTopDepObj origBuff = null;
		ICFBamPopTopDepEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamPopTopDepObj)schemaObj.getPopTopDepTableObj().newInstance();
			editBuff = (ICFBamPopTopDepEditObj)origBuff.beginEdit();
