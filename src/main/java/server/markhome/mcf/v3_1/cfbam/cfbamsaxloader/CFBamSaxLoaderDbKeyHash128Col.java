...
// Description: Java 25 XML SAX Element Handler for DbKeyHash128Col
...
/*
 *	CFBamSaxLoaderDbKeyHash128ColParse XML SAX Element Handler implementation
 *	for DbKeyHash128Col.
 */
public class CFBamSaxLoaderDbKeyHash128Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash128Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash128ColObj origBuff = null;
		ICFBamDbKeyHash128ColEditObj editBuff = null;
		...
		// DbKeyHash128Col Attributes
		// DbKeyHash128Col References
		...
		try {
			assert qName.equals( "DbKeyHash128Col" );
			...
			origBuff = (ICFBamDbKeyHash128ColObj)schemaObj.getDbKeyHash128ColTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash128ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash128ColLoaderBehaviour();
			ICFBamDbKeyHash128ColEditObj editDbKeyHash128Col = null;
			ICFBamDbKeyHash128ColObj origDbKeyHash128Col = (ICFBamDbKeyHash128ColObj)schemaObj.getDbKeyHash128ColTableObj().readDbKeyHash128ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash128Col == null ) {
				editDbKeyHash128Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash128Col = (ICFBamDbKeyHash128ColEditObj)origDbKeyHash128Col.beginEdit();
						editDbKeyHash128Col.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash128Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash128Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash128Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash128Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash128Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash128Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash128Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash128Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash128Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash128Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash128Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash128Col = (ICFBamDbKeyHash128ColEditObj)origDbKeyHash128Col.beginEdit();
						editDbKeyHash128Col.deleteInstance();
						editDbKeyHash128Col = null;
						origDbKeyHash128Col = null;
						editDbKeyHash128Col = editBuff;
						break;
				}
			}

			if( editDbKeyHash128Col != null ) {
				if( origDbKeyHash128Col != null ) {
					editDbKeyHash128Col.update();
				}
				else {
					origDbKeyHash128Col = (ICFBamDbKeyHash128ColObj)editDbKeyHash128Col.create();
				}
				editDbKeyHash128Col = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash128Col );
		}
