...
// Description: Java 25 XML SAX Element Handler for Int16Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt16ColObj origBuff = null;
		ICFBamInt16ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt16ColObj)schemaObj.getInt16ColTableObj().newInstance();
			editBuff = (ICFBamInt16ColEditObj)origBuff.beginEdit();
			...
			ICFBamInt16ColObj origInt16Col = (ICFBamInt16ColObj)schemaObj.getInt16ColTableObj().readInt16ColByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt16Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt16Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
