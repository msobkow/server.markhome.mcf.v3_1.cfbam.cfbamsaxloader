...
// Description: Java 25 XML SAX Element Handler for DbKeyHash256Type
...
/*
 *	CFBamSaxLoaderDbKeyHash256TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash256Type.
 */
public class CFBamSaxLoaderDbKeyHash256Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash256Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash256TypeObj origBuff = null;
		ICFBamDbKeyHash256TypeEditObj editBuff = null;
		...
		// Atom References
		// DbKeyHash256Def Attributes
		String attrInitValue = null;
		// DbKeyHash256Def References
		// DbKeyHash256Type Attributes
		...
		try {
			assert qName.equals( "DbKeyHash256Type" );
			...
			origBuff = (ICFBamDbKeyHash256TypeObj)schemaObj.getDbKeyHash256TypeTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash256TypeEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash256TypeLoaderBehaviour();
			ICFBamDbKeyHash256TypeEditObj editDbKeyHash256Type = null;
			ICFBamDbKeyHash256TypeObj origDbKeyHash256Type = (ICFBamDbKeyHash256TypeObj)schemaObj.getDbKeyHash256TypeTableObj().readDbKeyHash256TypeByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash256Type == null ) {
				editDbKeyHash256Type = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash256Type = (ICFBamDbKeyHash256TypeEditObj)origDbKeyHash256Type.beginEdit();
						editDbKeyHash256Type.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash256Type.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash256Type.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash256Type.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash256Type.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash256Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash256Type.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash256Type.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash256Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash256Type.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash256Type.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash256Type.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash256Type = (ICFBamDbKeyHash256TypeEditObj)origDbKeyHash256Type.beginEdit();
						editDbKeyHash256Type.deleteInstance();
						editDbKeyHash256Type = null;
						origDbKeyHash256Type = null;
						editDbKeyHash256Type = editBuff;
						break;
				}
			}

			if( editDbKeyHash256Type != null ) {
				if( origDbKeyHash256Type != null ) {
					editDbKeyHash256Type.update();
				}
				else {
					origDbKeyHash256Type = (ICFBamDbKeyHash256TypeObj)editDbKeyHash256Type.create();
				}
				editDbKeyHash256Type = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash256Type );
		}
