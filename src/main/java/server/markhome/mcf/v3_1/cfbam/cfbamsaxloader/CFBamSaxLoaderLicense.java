	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamLicenseObj origBuff = null;
		ICFBamLicenseEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamLicenseObj)schemaObj.getLicenseTableObj().newInstance();
			editBuff = (ICFBamLicenseEditObj)origBuff.beginEdit();
			...
			ICFBamLicenseObj origLicense = (ICFBamLicenseObj)schemaObj.getLicenseTableObj().readLicenseByUNameIdx( refTopDomain.getRequiredId(),
