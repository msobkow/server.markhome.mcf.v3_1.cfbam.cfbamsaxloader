...
// Description: Java 25 XML SAX Element Handler for BlobCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamBlobColObj origBuff = null;
		ICFBamBlobColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamBlobColObj)schemaObj.getBlobColTableObj().newInstance();
			editBuff = (ICFBamBlobColEditObj)origBuff.beginEdit();
			...
			ICFBamBlobColObj origBlobCol = (ICFBamBlobColObj)schemaObj.getBlobColTableObj().readBlobColByUNameIdx( refScope.getRequiredId(),
			...
			if( origBlobCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
