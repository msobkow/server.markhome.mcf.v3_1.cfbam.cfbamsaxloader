...
// Description: Java 25 XML SAX Element Handler for EnumType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamEnumTypeObj origBuff = null;
		ICFBamEnumTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamEnumTypeObj)schemaObj.getEnumTypeTableObj().newInstance();
			editBuff = (ICFBamEnumTypeEditObj)origBuff.beginEdit();
			...
			ICFBamEnumTypeObj origEnumType = (ICFBamEnumTypeObj)schemaObj.getEnumTypeTableObj().readEnumTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origEnumType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editEnumType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
