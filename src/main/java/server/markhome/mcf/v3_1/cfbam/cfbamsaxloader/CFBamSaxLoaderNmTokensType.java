...
// Description: Java 25 XML SAX Element Handler for NmTokensType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokensTypeObj origBuff = null;
		ICFBamNmTokensTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokensTypeObj)schemaObj.getNmTokensTypeTableObj().newInstance();
			editBuff = (ICFBamNmTokensTypeEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokensTypeObj origNmTokensType = (ICFBamNmTokensTypeObj)schemaObj.getNmTokensTypeTableObj().readNmTokensTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokensType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
