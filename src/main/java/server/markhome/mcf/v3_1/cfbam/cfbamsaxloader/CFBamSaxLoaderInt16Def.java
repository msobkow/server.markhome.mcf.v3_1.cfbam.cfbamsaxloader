...
// Description: Java 25 XML SAX Element Handler for Int16Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt16DefObj origBuff = null;
		ICFBamInt16DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt16DefObj)schemaObj.getInt16DefTableObj().newInstance();
			editBuff = (ICFBamInt16DefEditObj)origBuff.beginEdit();
			...
			ICFBamInt16DefObj origInt16Def = (ICFBamInt16DefObj)schemaObj.getInt16DefTableObj().readInt16DefByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt16Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt16Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
