...
// Description: Java 25 XML SAX Element Handler for DelSubDep2
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDelSubDep2Obj origBuff = null;
		ICFBamDelSubDep2EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDelSubDep2Obj)schemaObj.getDelSubDep2TableObj().newInstance();
			editBuff = (ICFBamDelSubDep2EditObj)origBuff.beginEdit();
