...
// Description: Java 25 XML SAX Element Handler for TextCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTextColObj origBuff = null;
		ICFBamTextColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTextColObj)schemaObj.getTextColTableObj().newInstance();
			editBuff = (ICFBamTextColEditObj)origBuff.beginEdit();
			...
			ICFBamTextColObj origTextCol = (ICFBamTextColObj)schemaObj.getTextColTableObj().readTextColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTextCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
