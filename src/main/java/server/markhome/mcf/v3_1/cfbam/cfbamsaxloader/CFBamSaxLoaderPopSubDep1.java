...
// Description: Java 25 XML SAX Element Handler for PopSubDep1
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamPopSubDep1Obj origBuff = null;
		ICFBamPopSubDep1EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamPopSubDep1Obj)schemaObj.getPopSubDep1TableObj().newInstance();
			editBuff = (ICFBamPopSubDep1EditObj)origBuff.beginEdit();
