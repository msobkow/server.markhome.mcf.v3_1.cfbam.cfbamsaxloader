...
// Description: Java 25 XML SAX Element Handler for Atom
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamAtomObj origBuff = null;
		ICFBamAtomEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamAtomObj)schemaObj.getAtomTableObj().newInstance();
			editBuff = (ICFBamAtomEditObj)origBuff.beginEdit();
			...
			ICFBamAtomObj origAtom = (ICFBamAtomObj)schemaObj.getAtomTableObj().readAtomByUNameIdx( refScope.getRequiredId(),
			...
			if( origAtom == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editAtom.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
