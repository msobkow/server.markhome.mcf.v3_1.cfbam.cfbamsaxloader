...
// Description: Java 25 XML SAX Element Handler for Uuid6Def
...
/*
 *	CFBamSaxLoaderUuid6DefParse XML SAX Element Handler implementation
 *	for Uuid6Def.
 */
public class CFBamSaxLoaderUuid6Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuid6Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamUuid6DefObj origBuff = null;
		ICFBamUuid6DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuid6DefObj)schemaObj.getUuid6DefTableObj().newInstance();
			editBuff = (ICFBamUuid6DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getUuid6DefLoaderBehaviour();
			ICFBamUuid6DefEditObj editUuid6Def = null;
			ICFBamUuid6DefObj origUuid6Def = (ICFBamUuid6DefObj)schemaObj.getUuid6DefTableObj().readUuid6DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origUuid6Def == null ) {
				editUuid6Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editUuid6Def = (ICFBamUuid6DefEditObj)origUuid6Def.beginEdit();
						editUuid6Def.setRequiredName( editBuff.getRequiredName() );
						editUuid6Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editUuid6Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editUuid6Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editUuid6Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editUuid6Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editUuid6Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editUuid6Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editUuid6Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editUuid6Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editUuid6Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editUuid6Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editUuid6Def = (ICFBamUuid6DefEditObj)origUuid6Def.beginEdit();
						editUuid6Def.deleteInstance();
						editUuid6Def = null;
						origUuid6Def = null;
						editUuid6Def = editBuff;
						break;
			...
			if( editUuid6Def != null ) {
				if( origUuid6Def != null ) {
					editUuid6Def.update();
				}
				else {
					origUuid6Def = (ICFBamUuid6DefObj)editUuid6Def.create();
				}
				editUuid6Def = null;
			}

			curContext.putNamedValue( "Object", origUuid6Def );
		}
