...
// Description: Java 25 XML SAX Element Handler for TZTimestampType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimestampTypeObj origBuff = null;
		ICFBamTZTimestampTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimestampTypeObj)schemaObj.getTZTimestampTypeTableObj().newInstance();
			editBuff = (ICFBamTZTimestampTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimestampTypeObj origTZTimestampType = (ICFBamTZTimestampTypeObj)schemaObj.getTZTimestampTypeTableObj().readTZTimestampTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZTimestampType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimestampType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
