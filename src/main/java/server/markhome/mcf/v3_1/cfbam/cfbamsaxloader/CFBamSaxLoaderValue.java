...
// Description: Java 25 XML SAX Element Handler for Value
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamValueObj origValue = (ICFBamValueObj)schemaObj.getValueTableObj().readValueByUNameIdx( refScope.getRequiredId(),
