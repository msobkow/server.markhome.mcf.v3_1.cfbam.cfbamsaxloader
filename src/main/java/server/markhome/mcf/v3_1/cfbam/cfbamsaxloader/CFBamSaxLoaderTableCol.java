...
// Description: Java 25 XML SAX Element Handler for TableCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTableColObj origBuff = null;
		ICFBamTableColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTableColObj)schemaObj.getTableColTableObj().newInstance();
			editBuff = (ICFBamTableColEditObj)origBuff.beginEdit();
			...
			ICFBamTableColObj origTableCol = (ICFBamTableColObj)schemaObj.getTableColTableObj().readTableColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTableCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTableCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
