...
// Description: Java 25 XML SAX Element Handler for TimeDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimeDefObj origBuff = null;
		ICFBamTimeDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimeDefObj)schemaObj.getTimeDefTableObj().newInstance();
			editBuff = (ICFBamTimeDefEditObj)origBuff.beginEdit();
			...
			ICFBamTimeDefObj origTimeDef = (ICFBamTimeDefObj)schemaObj.getTimeDefTableObj().readTimeDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimeDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
