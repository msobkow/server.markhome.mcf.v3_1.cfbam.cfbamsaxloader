...
// Description: Java 25 XML SAX Element Handler for ClearSubDep3
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamClearSubDep3Obj origBuff = null;
		ICFBamClearSubDep3EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamClearSubDep3Obj)schemaObj.getClearSubDep3TableObj().newInstance();
			editBuff = (ICFBamClearSubDep3EditObj)origBuff.beginEdit();
