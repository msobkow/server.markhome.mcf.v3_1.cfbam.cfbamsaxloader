...
// Description: Java 25 XML SAX Element Handler for Index
		...
		try {
			...
			if( attrIsUnique.equals( "true" ) || attrIsUnique.equals( "yes" ) || attrIsUnique.equals( "1" ) ) {
				...
				throw new CFLibUsageException( getClass(),
					S_ProcName,
					String.format(Inz.x("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsUnique", attrIsUnique),
					String.format(Inz.s("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsUnique", attrIsUnique));
			}
			...
			if( attrIsDbMapped.equals( "true" ) || attrIsDbMapped.equals( "yes" ) || attrIsDbMapped.equals( "1" ) ) {
				...
				throw new CFLibUsageException( getClass(),
					S_ProcName,
					String.format(Inz.x("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsDbMapped", attrIsDbMapped),
					String.format(Inz.s("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsDbMapped", attrIsDbMapped));
			}
			...
			ICFBamIndexObj origIndex = (ICFBamIndexObj)schemaObj.getIndexTableObj().readIndexByUNameIdx( refTable.getRequiredId(),
