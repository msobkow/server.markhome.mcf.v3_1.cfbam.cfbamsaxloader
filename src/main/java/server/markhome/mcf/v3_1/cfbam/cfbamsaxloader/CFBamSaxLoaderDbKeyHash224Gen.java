...
// Description: Java 25 XML SAX Element Handler for DbKeyHash224Gen
...
/*
 *	CFBamSaxLoaderDbKeyHash224GenParse XML SAX Element Handler implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamSaxLoaderDbKeyHash224Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash224Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash224GenObj origBuff = null;
		ICFBamDbKeyHash224GenEditObj editBuff = null;
		...
		// Atom References
		// DbKeyHash224Def Attributes
		String attrInitValue = null;
		// DbKeyHash224Def References
		// DbKeyHash224Type Attributes
		// DbKeyHash224Type References
		ICFBamSchemaDefObj refSchemaDef = null;
		// DbKeyHash224Gen Attributes
		String attrSlice = null;
		String attrBlockSize = null;
		// DbKeyHash224Gen References
		...
		try {
			assert qName.equals( "DbKeyHash224Gen" );
			...
			origBuff = (ICFBamDbKeyHash224GenObj)schemaObj.getDbKeyHash224GenTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash224GenEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash224GenLoaderBehaviour();
			ICFBamDbKeyHash224GenEditObj editDbKeyHash224Gen = null;
			ICFBamDbKeyHash224GenObj origDbKeyHash224Gen = (ICFBamDbKeyHash224GenObj)schemaObj.getDbKeyHash224GenTableObj().readDbKeyHash224GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash224Gen == null ) {
				editDbKeyHash224Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash224Gen = (ICFBamDbKeyHash224GenEditObj)origDbKeyHash224Gen.beginEdit();
						editDbKeyHash224Gen.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash224Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash224Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash224Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash224Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash224Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash224Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash224Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash224Gen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash224Gen.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash224Gen.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash224Gen.setRequiredSlice( editBuff.getRequiredSlice() );
						editDbKeyHash224Gen.setRequiredBlockSize( editBuff.getRequiredBlockSize() );
						editDbKeyHash224Gen.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash224Gen = (ICFBamDbKeyHash224GenEditObj)origDbKeyHash224Gen.beginEdit();
						editDbKeyHash224Gen.deleteInstance();
						editDbKeyHash224Gen = null;
						origDbKeyHash224Gen = null;
						editDbKeyHash224Gen = editBuff;
						break;
				}
			}

			if( editDbKeyHash224Gen != null ) {
				if( origDbKeyHash224Gen != null ) {
					editDbKeyHash224Gen.update();
				}
				else {
					origDbKeyHash224Gen = (ICFBamDbKeyHash224GenObj)editDbKeyHash224Gen.create();
				}
				editDbKeyHash224Gen = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash224Gen );
		}
