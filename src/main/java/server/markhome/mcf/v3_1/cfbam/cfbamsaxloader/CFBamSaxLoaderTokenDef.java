...
// Description: Java 25 XML SAX Element Handler for TokenDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTokenDefObj origBuff = null;
		ICFBamTokenDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTokenDefObj)schemaObj.getTokenDefTableObj().newInstance();
			editBuff = (ICFBamTokenDefEditObj)origBuff.beginEdit();
			...
			ICFBamTokenDefObj origTokenDef = (ICFBamTokenDefObj)schemaObj.getTokenDefTableObj().readTokenDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTokenDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
