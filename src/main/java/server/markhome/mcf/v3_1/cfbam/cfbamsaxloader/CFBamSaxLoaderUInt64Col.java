...
// Description: Java 25 XML SAX Element Handler for UInt64Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt64ColObj origBuff = null;
		ICFBamUInt64ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt64ColObj)schemaObj.getUInt64ColTableObj().newInstance();
			editBuff = (ICFBamUInt64ColEditObj)origBuff.beginEdit();
			...
			ICFBamUInt64ColObj origUInt64Col = (ICFBamUInt64ColObj)schemaObj.getUInt64ColTableObj().readUInt64ColByUNameIdx( refScope.getRequiredId(),
