...
// Description: Java 25 XML SAX Element Handler for PopSubDep3
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamPopSubDep3Obj origBuff = null;
		ICFBamPopSubDep3EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamPopSubDep3Obj)schemaObj.getPopSubDep3TableObj().newInstance();
			editBuff = (ICFBamPopSubDep3EditObj)origBuff.beginEdit();
