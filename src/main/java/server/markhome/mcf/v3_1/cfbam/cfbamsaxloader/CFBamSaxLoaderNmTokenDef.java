...
// Description: Java 25 XML SAX Element Handler for NmTokenDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokenDefObj origBuff = null;
		ICFBamNmTokenDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokenDefObj)schemaObj.getNmTokenDefTableObj().newInstance();
			editBuff = (ICFBamNmTokenDefEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokenDefObj origNmTokenDef = (ICFBamNmTokenDefObj)schemaObj.getNmTokenDefTableObj().readNmTokenDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokenDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
