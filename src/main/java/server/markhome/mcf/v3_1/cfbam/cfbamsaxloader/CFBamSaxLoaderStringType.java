...
// Description: Java 25 XML SAX Element Handler for StringType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamStringTypeObj origBuff = null;
		ICFBamStringTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamStringTypeObj)schemaObj.getStringTypeTableObj().newInstance();
			editBuff = (ICFBamStringTypeEditObj)origBuff.beginEdit();
			...
			ICFBamStringTypeObj origStringType = (ICFBamStringTypeObj)schemaObj.getStringTypeTableObj().readStringTypeByUNameIdx( refScope.getRequiredId(),
