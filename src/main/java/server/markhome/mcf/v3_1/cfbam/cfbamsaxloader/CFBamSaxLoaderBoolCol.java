...
// Description: Java 25 XML SAX Element Handler for BoolCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamBoolColObj origBuff = null;
		ICFBamBoolColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamBoolColObj)schemaObj.getBoolColTableObj().newInstance();
			editBuff = (ICFBamBoolColEditObj)origBuff.beginEdit();
			...
			ICFBamBoolColObj origBoolCol = (ICFBamBoolColObj)schemaObj.getBoolColTableObj().readBoolColByUNameIdx( refScope.getRequiredId(),
			...
			if( origBoolCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBoolCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
