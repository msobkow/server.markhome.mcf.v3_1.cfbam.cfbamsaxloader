...
// Description: Java 25 XML SAX Element Handler for DbKeyHash160Def
...
/*
 *	CFBamSaxLoaderDbKeyHash160DefParse XML SAX Element Handler implementation
 *	for DbKeyHash160Def.
 */
public class CFBamSaxLoaderDbKeyHash160Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash160Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash160DefObj origBuff = null;
		ICFBamDbKeyHash160DefEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash160Def" );
			...
			origBuff = (ICFBamDbKeyHash160DefObj)schemaObj.getDbKeyHash160DefTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash160DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash160DefLoaderBehaviour();
			ICFBamDbKeyHash160DefEditObj editDbKeyHash160Def = null;
			ICFBamDbKeyHash160DefObj origDbKeyHash160Def = (ICFBamDbKeyHash160DefObj)schemaObj.getDbKeyHash160DefTableObj().readDbKeyHash160DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash160Def == null ) {
				editDbKeyHash160Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash160Def = (ICFBamDbKeyHash160DefEditObj)origDbKeyHash160Def.beginEdit();
						editDbKeyHash160Def.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash160Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash160Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash160Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash160Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash160Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash160Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash160Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash160Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash160Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash160Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash160Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash160Def = (ICFBamDbKeyHash160DefEditObj)origDbKeyHash160Def.beginEdit();
						editDbKeyHash160Def.deleteInstance();
						editDbKeyHash160Def = null;
						origDbKeyHash160Def = null;
						editDbKeyHash160Def = editBuff;
						break;
				}
			}

			if( editDbKeyHash160Def != null ) {
				if( origDbKeyHash160Def != null ) {
					editDbKeyHash160Def.update();
				}
				else {
					origDbKeyHash160Def = (ICFBamDbKeyHash160DefObj)editDbKeyHash160Def.create();
				}
				editDbKeyHash160Def = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash160Def );
		}
