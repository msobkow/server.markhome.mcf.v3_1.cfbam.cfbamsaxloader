...
// Description: Java 25 XML SAX Element Handler for DateCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDateColObj origBuff = null;
		ICFBamDateColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDateColObj)schemaObj.getDateColTableObj().newInstance();
			editBuff = (ICFBamDateColEditObj)origBuff.beginEdit();
			...
			ICFBamDateColObj origDateCol = (ICFBamDateColObj)schemaObj.getDateColTableObj().readDateColByUNameIdx( refScope.getRequiredId(),
			...
			if( origDateCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
