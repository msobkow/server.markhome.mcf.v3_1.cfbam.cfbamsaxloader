...
// Description: Java 25 XML SAX Element Handler for DbKeyHash128Gen
...
/*
 *	CFBamSaxLoaderDbKeyHash128GenParse XML SAX Element Handler implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamSaxLoaderDbKeyHash128Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash128Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash128GenObj origBuff = null;
		ICFBamDbKeyHash128GenEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash128Gen" );
			...
			origBuff = (ICFBamDbKeyHash128GenObj)schemaObj.getDbKeyHash128GenTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash128GenEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash128GenLoaderBehaviour();
			ICFBamDbKeyHash128GenEditObj editDbKeyHash128Gen = null;
			ICFBamDbKeyHash128GenObj origDbKeyHash128Gen = (ICFBamDbKeyHash128GenObj)schemaObj.getDbKeyHash128GenTableObj().readDbKeyHash128GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash128Gen == null ) {
				editDbKeyHash128Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash128Gen = (ICFBamDbKeyHash128GenEditObj)origDbKeyHash128Gen.beginEdit();
						editDbKeyHash128Gen.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash128Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash128Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash128Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash128Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash128Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash128Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash128Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash128Gen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash128Gen.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash128Gen.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash128Gen.setRequiredSlice( editBuff.getRequiredSlice() );
						editDbKeyHash128Gen.setRequiredBlockSize( editBuff.getRequiredBlockSize() );
						editDbKeyHash128Gen.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash128Gen = (ICFBamDbKeyHash128GenEditObj)origDbKeyHash128Gen.beginEdit();
						editDbKeyHash128Gen.deleteInstance();
						editDbKeyHash128Gen = null;
						origDbKeyHash128Gen = null;
						editDbKeyHash128Gen = editBuff;
						break;
				}
			}

			if( editDbKeyHash128Gen != null ) {
				if( origDbKeyHash128Gen != null ) {
					editDbKeyHash128Gen.update();
				}
				else {
					origDbKeyHash128Gen = (ICFBamDbKeyHash128GenObj)editDbKeyHash128Gen.create();
				}
				editDbKeyHash128Gen = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash128Gen );
		}
