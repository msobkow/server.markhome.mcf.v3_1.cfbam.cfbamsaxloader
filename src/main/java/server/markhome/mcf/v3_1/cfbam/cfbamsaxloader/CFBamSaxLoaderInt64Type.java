...
// Description: Java 25 XML SAX Element Handler for Int64Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt64TypeObj origBuff = null;
		ICFBamInt64TypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt64TypeObj)schemaObj.getInt64TypeTableObj().newInstance();
			editBuff = (ICFBamInt64TypeEditObj)origBuff.beginEdit();
			...
			ICFBamInt64TypeObj origInt64Type = (ICFBamInt64TypeObj)schemaObj.getInt64TypeTableObj().readInt64TypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt64Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt64Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
