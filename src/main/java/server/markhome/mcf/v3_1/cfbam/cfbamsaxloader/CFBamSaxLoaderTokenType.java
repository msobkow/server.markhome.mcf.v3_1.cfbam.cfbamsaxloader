...
// Description: Java 25 XML SAX Element Handler for TokenType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTokenTypeObj origBuff = null;
		ICFBamTokenTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTokenTypeObj)schemaObj.getTokenTypeTableObj().newInstance();
			editBuff = (ICFBamTokenTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTokenTypeObj origTokenType = (ICFBamTokenTypeObj)schemaObj.getTokenTypeTableObj().readTokenTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTokenType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
