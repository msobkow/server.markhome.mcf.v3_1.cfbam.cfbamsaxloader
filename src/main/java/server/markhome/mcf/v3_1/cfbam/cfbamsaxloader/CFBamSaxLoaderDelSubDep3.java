...
// Description: Java 25 XML SAX Element Handler for DelSubDep3
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDelSubDep3Obj origBuff = null;
		ICFBamDelSubDep3EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDelSubDep3Obj)schemaObj.getDelSubDep3TableObj().newInstance();
			editBuff = (ICFBamDelSubDep3EditObj)origBuff.beginEdit();
