...
// Description: Java 25 XML SAX Element Handler for DbKeyHash256Def
...
/*
 *	CFBamSaxLoaderDbKeyHash256DefParse XML SAX Element Handler implementation
 *	for DbKeyHash256Def.
 */
public class CFBamSaxLoaderDbKeyHash256Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash256Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash256DefObj origBuff = null;
		ICFBamDbKeyHash256DefEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash256Def" );
			...
			origBuff = (ICFBamDbKeyHash256DefObj)schemaObj.getDbKeyHash256DefTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash256DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash256DefLoaderBehaviour();
			ICFBamDbKeyHash256DefEditObj editDbKeyHash256Def = null;
			ICFBamDbKeyHash256DefObj origDbKeyHash256Def = (ICFBamDbKeyHash256DefObj)schemaObj.getDbKeyHash256DefTableObj().readDbKeyHash256DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash256Def == null ) {
				editDbKeyHash256Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash256Def = (ICFBamDbKeyHash256DefEditObj)origDbKeyHash256Def.beginEdit();
						editDbKeyHash256Def.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash256Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash256Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash256Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash256Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash256Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash256Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash256Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash256Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash256Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash256Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash256Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash256Def = (ICFBamDbKeyHash256DefEditObj)origDbKeyHash256Def.beginEdit();
						editDbKeyHash256Def.deleteInstance();
						editDbKeyHash256Def = null;
						origDbKeyHash256Def = null;
						editDbKeyHash256Def = editBuff;
						break;
				}
			}

			if( editDbKeyHash256Def != null ) {
				if( origDbKeyHash256Def != null ) {
					editDbKeyHash256Def.update();
				}
				else {
					origDbKeyHash256Def = (ICFBamDbKeyHash256DefObj)editDbKeyHash256Def.create();
				}
				editDbKeyHash256Def = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash256Def );
		}
