...
// Description: Java 25 XML SAX Element Handler for UuidDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUuidDefObj origBuff = null;
		ICFBamUuidDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuidDefObj)schemaObj.getUuidDefTableObj().newInstance();
			editBuff = (ICFBamUuidDefEditObj)origBuff.beginEdit();
			...
			ICFBamUuidDefObj origUuidDef = (ICFBamUuidDefObj)schemaObj.getUuidDefTableObj().readUuidDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origUuidDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
