...
// Description: Java 25 XML SAX Element Handler for DateDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDateDefObj origBuff = null;
		ICFBamDateDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDateDefObj)schemaObj.getDateDefTableObj().newInstance();
			editBuff = (ICFBamDateDefEditObj)origBuff.beginEdit();
			...
			ICFBamDateDefObj origDateDef = (ICFBamDateDefObj)schemaObj.getDateDefTableObj().readDateDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origDateDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
