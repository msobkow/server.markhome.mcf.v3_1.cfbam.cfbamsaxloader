...
// Description: Java 25 XML SAX Element Handler for NmTokenType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokenTypeObj origBuff = null;
		ICFBamNmTokenTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokenTypeObj)schemaObj.getNmTokenTypeTableObj().newInstance();
			editBuff = (ICFBamNmTokenTypeEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokenTypeObj origNmTokenType = (ICFBamNmTokenTypeObj)schemaObj.getNmTokenTypeTableObj().readNmTokenTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokenType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
