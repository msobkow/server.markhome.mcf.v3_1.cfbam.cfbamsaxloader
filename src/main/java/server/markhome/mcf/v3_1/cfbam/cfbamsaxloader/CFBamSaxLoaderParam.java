...
// Description: Java 25 XML SAX Element Handler for Param
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamParamObj origBuff = null;
		ICFBamParamEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamParamObj)schemaObj.getParamTableObj().newInstance();
			editBuff = (ICFBamParamEditObj)origBuff.beginEdit();
