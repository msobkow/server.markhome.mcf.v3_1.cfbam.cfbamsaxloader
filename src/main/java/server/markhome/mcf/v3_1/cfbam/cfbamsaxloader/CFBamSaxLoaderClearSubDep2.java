...
// Description: Java 25 XML SAX Element Handler for ClearSubDep2
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamClearSubDep2Obj origBuff = null;
		ICFBamClearSubDep2EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamClearSubDep2Obj)schemaObj.getClearSubDep2TableObj().newInstance();
			editBuff = (ICFBamClearSubDep2EditObj)origBuff.beginEdit();
