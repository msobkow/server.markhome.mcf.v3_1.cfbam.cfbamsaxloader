...
// Description: Java 25 XML SAX Element Handler for Int64Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt64ColObj origBuff = null;
		ICFBamInt64ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt64ColObj)schemaObj.getInt64ColTableObj().newInstance();
			editBuff = (ICFBamInt64ColEditObj)origBuff.beginEdit();
			...
			ICFBamInt64ColObj origInt64Col = (ICFBamInt64ColObj)schemaObj.getInt64ColTableObj().readInt64ColByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt64Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt64Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
