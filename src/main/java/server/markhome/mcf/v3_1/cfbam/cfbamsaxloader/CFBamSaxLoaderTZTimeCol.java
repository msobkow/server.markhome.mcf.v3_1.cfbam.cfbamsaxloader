...
// Description: Java 25 XML SAX Element Handler for TZTimeCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimeColObj origBuff = null;
		ICFBamTZTimeColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimeColObj)schemaObj.getTZTimeColTableObj().newInstance();
			editBuff = (ICFBamTZTimeColEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimeColObj origTZTimeCol = (ICFBamTZTimeColObj)schemaObj.getTZTimeColTableObj().readTZTimeColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZTimeCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimeCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
