...
// Description: Java 25 XML SAX Element Handler for NumberCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNumberColObj origBuff = null;
		ICFBamNumberColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNumberColObj)schemaObj.getNumberColTableObj().newInstance();
			editBuff = (ICFBamNumberColEditObj)origBuff.beginEdit();
			...
			ICFBamNumberColObj origNumberCol = (ICFBamNumberColObj)schemaObj.getNumberColTableObj().readNumberColByUNameIdx( refScope.getRequiredId(),
			...
			if( origNumberCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNumberCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
