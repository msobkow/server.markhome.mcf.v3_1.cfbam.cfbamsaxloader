...
// Description: Java 25 XML SAX Element Handler for DateType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDateTypeObj origBuff = null;
		ICFBamDateTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDateTypeObj)schemaObj.getDateTypeTableObj().newInstance();
			editBuff = (ICFBamDateTypeEditObj)origBuff.beginEdit();
			...
			ICFBamDateTypeObj origDateType = (ICFBamDateTypeObj)schemaObj.getDateTypeTableObj().readDateTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origDateType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
