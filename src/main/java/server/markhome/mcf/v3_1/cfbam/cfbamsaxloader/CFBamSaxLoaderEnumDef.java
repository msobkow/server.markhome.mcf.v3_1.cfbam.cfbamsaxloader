...
// Description: Java 25 XML SAX Element Handler for EnumDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamEnumDefObj origBuff = null;
		ICFBamEnumDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamEnumDefObj)schemaObj.getEnumDefTableObj().newInstance();
			editBuff = (ICFBamEnumDefEditObj)origBuff.beginEdit();
			...
			ICFBamEnumDefObj origEnumDef = (ICFBamEnumDefObj)schemaObj.getEnumDefTableObj().readEnumDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origEnumDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editEnumDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
