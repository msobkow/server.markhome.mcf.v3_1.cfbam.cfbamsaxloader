	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamSecTentGrpMembObj origSecTentGrpMemb = (ICFBamSecTentGrpMembObj)schemaObj.getSecTentGrpMembTableObj().readSecTentGrpMembByIdIdx( refGroup.getRequiredSecTentGrpId(),
			...
			if( origSecTentGrpMemb == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editSecTentGrpMemb.setRequiredParentUser( editBuff.getRequiredParentUser() );
						break;
					case Replace:
						editSecTentGrpMemb = (ICFBamSecTentGrpMembEditObj)origSecTentGrpMemb.beginEdit();
