...
// Description: Java 25 XML SAX Element Handler for BlobType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamBlobTypeObj origBuff = null;
		ICFBamBlobTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamBlobTypeObj)schemaObj.getBlobTypeTableObj().newInstance();
			editBuff = (ICFBamBlobTypeEditObj)origBuff.beginEdit();
			...
			ICFBamBlobTypeObj origBlobType = (ICFBamBlobTypeObj)schemaObj.getBlobTypeTableObj().readBlobTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origBlobType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
