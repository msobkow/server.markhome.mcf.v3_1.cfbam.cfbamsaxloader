...
// Description: Java 25 XML SAX Element Handler for NmTokensDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokensDefObj origBuff = null;
		ICFBamNmTokensDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokensDefObj)schemaObj.getNmTokensDefTableObj().newInstance();
			editBuff = (ICFBamNmTokensDefEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokensDefObj origNmTokensDef = (ICFBamNmTokensDefObj)schemaObj.getNmTokensDefTableObj().readNmTokensDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokensDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
