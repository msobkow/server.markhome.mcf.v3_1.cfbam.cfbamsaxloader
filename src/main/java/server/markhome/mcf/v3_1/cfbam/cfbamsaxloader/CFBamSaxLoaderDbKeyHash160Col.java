...
// Description: Java 25 XML SAX Element Handler for DbKeyHash160Col
...
/*
 *	CFBamSaxLoaderDbKeyHash160ColParse XML SAX Element Handler implementation
 *	for DbKeyHash160Col.
 */
public class CFBamSaxLoaderDbKeyHash160Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash160Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash160ColObj origBuff = null;
		ICFBamDbKeyHash160ColEditObj editBuff = null;
		...
		// DbKeyHash160Col Attributes
		// DbKeyHash160Col References
		...
		try {
			assert qName.equals( "DbKeyHash160Col" );
			...
			origBuff = (ICFBamDbKeyHash160ColObj)schemaObj.getDbKeyHash160ColTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash160ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash160ColLoaderBehaviour();
			ICFBamDbKeyHash160ColEditObj editDbKeyHash160Col = null;
			ICFBamDbKeyHash160ColObj origDbKeyHash160Col = (ICFBamDbKeyHash160ColObj)schemaObj.getDbKeyHash160ColTableObj().readDbKeyHash160ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash160Col == null ) {
				editDbKeyHash160Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash160Col = (ICFBamDbKeyHash160ColEditObj)origDbKeyHash160Col.beginEdit();
						editDbKeyHash160Col.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash160Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash160Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash160Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash160Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash160Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash160Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash160Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash160Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash160Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash160Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash160Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash160Col = (ICFBamDbKeyHash160ColEditObj)origDbKeyHash160Col.beginEdit();
						editDbKeyHash160Col.deleteInstance();
						editDbKeyHash160Col = null;
						origDbKeyHash160Col = null;
						editDbKeyHash160Col = editBuff;
						break;
				}
			}

			if( editDbKeyHash160Col != null ) {
				if( origDbKeyHash160Col != null ) {
					editDbKeyHash160Col.update();
				}
				else {
					origDbKeyHash160Col = (ICFBamDbKeyHash160ColObj)editDbKeyHash160Col.create();
				}
				editDbKeyHash160Col = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash160Col );
		}
