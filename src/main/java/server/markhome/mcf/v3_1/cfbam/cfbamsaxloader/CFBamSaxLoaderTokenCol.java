...
// Description: Java 25 XML SAX Element Handler for TokenCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTokenColObj origBuff = null;
		ICFBamTokenColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTokenColObj)schemaObj.getTokenColTableObj().newInstance();
			editBuff = (ICFBamTokenColEditObj)origBuff.beginEdit();
			...
			ICFBamTokenColObj origTokenCol = (ICFBamTokenColObj)schemaObj.getTokenColTableObj().readTokenColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTokenCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
