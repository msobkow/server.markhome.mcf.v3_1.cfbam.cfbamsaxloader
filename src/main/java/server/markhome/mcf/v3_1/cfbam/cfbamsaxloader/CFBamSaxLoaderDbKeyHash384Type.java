...
// Description: Java 25 XML SAX Element Handler for DbKeyHash384Type
...
/*
 *	CFBamSaxLoaderDbKeyHash384TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash384Type.
 */
public class CFBamSaxLoaderDbKeyHash384Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash384Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash384TypeObj origBuff = null;
		ICFBamDbKeyHash384TypeEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash384Type" );
			...
			origBuff = (ICFBamDbKeyHash384TypeObj)schemaObj.getDbKeyHash384TypeTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash384TypeEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash384TypeLoaderBehaviour();
			ICFBamDbKeyHash384TypeEditObj editDbKeyHash384Type = null;
			ICFBamDbKeyHash384TypeObj origDbKeyHash384Type = (ICFBamDbKeyHash384TypeObj)schemaObj.getDbKeyHash384TypeTableObj().readDbKeyHash384TypeByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash384Type == null ) {
				editDbKeyHash384Type = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash384Type = (ICFBamDbKeyHash384TypeEditObj)origDbKeyHash384Type.beginEdit();
						editDbKeyHash384Type.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash384Type.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash384Type.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash384Type.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash384Type.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash384Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash384Type.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash384Type.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash384Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash384Type.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash384Type.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash384Type.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash384Type = (ICFBamDbKeyHash384TypeEditObj)origDbKeyHash384Type.beginEdit();
						editDbKeyHash384Type.deleteInstance();
						editDbKeyHash384Type = null;
						origDbKeyHash384Type = null;
						editDbKeyHash384Type = editBuff;
						break;
				}
			}

			if( editDbKeyHash384Type != null ) {
				if( origDbKeyHash384Type != null ) {
					editDbKeyHash384Type.update();
				}
				else {
					origDbKeyHash384Type = (ICFBamDbKeyHash384TypeObj)editDbKeyHash384Type.create();
				}
				editDbKeyHash384Type = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash384Type );
		}
