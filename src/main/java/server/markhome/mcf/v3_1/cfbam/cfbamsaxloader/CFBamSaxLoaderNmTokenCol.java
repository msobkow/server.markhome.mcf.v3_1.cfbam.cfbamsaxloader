...
// Description: Java 25 XML SAX Element Handler for NmTokenCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokenColObj origBuff = null;
		ICFBamNmTokenColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokenColObj)schemaObj.getNmTokenColTableObj().newInstance();
			editBuff = (ICFBamNmTokenColEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokenColObj origNmTokenCol = (ICFBamNmTokenColObj)schemaObj.getNmTokenColTableObj().readNmTokenColByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokenCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
