...
// Description: Java 25 XML SAX Element Handler for PopDep
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamPopDepObj origBuff = null;
		ICFBamPopDepEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamPopDepObj)schemaObj.getPopDepTableObj().newInstance();
			editBuff = (ICFBamPopDepEditObj)origBuff.beginEdit();
