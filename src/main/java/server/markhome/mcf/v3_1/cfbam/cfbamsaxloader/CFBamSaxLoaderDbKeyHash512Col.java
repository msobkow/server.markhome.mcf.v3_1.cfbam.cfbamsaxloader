...
// Description: Java 25 XML SAX Element Handler for DbKeyHash512Col
...
/*
 *	CFBamSaxLoaderDbKeyHash512ColParse XML SAX Element Handler implementation
 *	for DbKeyHash512Col.
 */
public class CFBamSaxLoaderDbKeyHash512Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash512Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash512ColObj origBuff = null;
		ICFBamDbKeyHash512ColEditObj editBuff = null;
		...
		// DbKeyHash512Col Attributes
		// DbKeyHash512Col References
		...
		try {
			assert qName.equals( "DbKeyHash512Col" );
			...
			origBuff = (ICFBamDbKeyHash512ColObj)schemaObj.getDbKeyHash512ColTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash512ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash512ColLoaderBehaviour();
			ICFBamDbKeyHash512ColEditObj editDbKeyHash512Col = null;
			ICFBamDbKeyHash512ColObj origDbKeyHash512Col = (ICFBamDbKeyHash512ColObj)schemaObj.getDbKeyHash512ColTableObj().readDbKeyHash512ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash512Col == null ) {
				editDbKeyHash512Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash512Col = (ICFBamDbKeyHash512ColEditObj)origDbKeyHash512Col.beginEdit();
						editDbKeyHash512Col.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash512Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash512Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash512Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash512Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash512Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash512Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash512Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash512Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash512Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash512Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash512Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash512Col = (ICFBamDbKeyHash512ColEditObj)origDbKeyHash512Col.beginEdit();
						editDbKeyHash512Col.deleteInstance();
						editDbKeyHash512Col = null;
						origDbKeyHash512Col = null;
						editDbKeyHash512Col = editBuff;
						break;
				}
			}

			if( editDbKeyHash512Col != null ) {
				if( origDbKeyHash512Col != null ) {
					editDbKeyHash512Col.update();
				}
				else {
					origDbKeyHash512Col = (ICFBamDbKeyHash512ColObj)editDbKeyHash512Col.create();
				}
				editDbKeyHash512Col = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash512Col );
		}
