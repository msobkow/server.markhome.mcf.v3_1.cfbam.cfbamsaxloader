...
// Description: Java 25 XML SAX Element Handler for TZTimeType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimeTypeObj origBuff = null;
		ICFBamTZTimeTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimeTypeObj)schemaObj.getTZTimeTypeTableObj().newInstance();
			editBuff = (ICFBamTZTimeTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimeTypeObj origTZTimeType = (ICFBamTZTimeTypeObj)schemaObj.getTZTimeTypeTableObj().readTZTimeTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZTimeType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimeType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
