...
// Description: Java 25 XML SAX Element Handler for TimestampCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimestampColObj origBuff = null;
		ICFBamTimestampColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimestampColObj)schemaObj.getTimestampColTableObj().newInstance();
			editBuff = (ICFBamTimestampColEditObj)origBuff.beginEdit();
			...
			ICFBamTimestampColObj origTimestampCol = (ICFBamTimestampColObj)schemaObj.getTimestampColTableObj().readTimestampColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimestampCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimestampCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
