...
// Description: Java 25 XML SAX Element Handler for FloatType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamFloatTypeObj origBuff = null;
		ICFBamFloatTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamFloatTypeObj)schemaObj.getFloatTypeTableObj().newInstance();
			editBuff = (ICFBamFloatTypeEditObj)origBuff.beginEdit();
			...
			ICFBamFloatTypeObj origFloatType = (ICFBamFloatTypeObj)schemaObj.getFloatTypeTableObj().readFloatTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origFloatType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
