...
// Description: Java 25 XML SAX Element Handler for StringDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamStringDefObj origBuff = null;
		ICFBamStringDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamStringDefObj)schemaObj.getStringDefTableObj().newInstance();
			editBuff = (ICFBamStringDefEditObj)origBuff.beginEdit();
			...
			ICFBamStringDefObj origStringDef = (ICFBamStringDefObj)schemaObj.getStringDefTableObj().readStringDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origStringDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editStringDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editStringDef.setOptionalDbName( editBuff.getOptionalDbName() );
						editStringDef.setRequiredMaxLen( editBuff.getRequiredMaxLen() );
						editStringDef.setRequiredIsPolymorph( editBuff.getRequiredIsPolymorph() );
