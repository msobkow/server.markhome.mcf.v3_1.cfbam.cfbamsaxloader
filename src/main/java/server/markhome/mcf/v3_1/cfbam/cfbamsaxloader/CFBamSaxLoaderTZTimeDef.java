...
// Description: Java 25 XML SAX Element Handler for TZTimeDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimeDefObj origBuff = null;
		ICFBamTZTimeDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimeDefObj)schemaObj.getTZTimeDefTableObj().newInstance();
			editBuff = (ICFBamTZTimeDefEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimeDefObj origTZTimeDef = (ICFBamTZTimeDefObj)schemaObj.getTZTimeDefTableObj().readTZTimeDefByUNameIdx( refScope.getRequiredId(),
