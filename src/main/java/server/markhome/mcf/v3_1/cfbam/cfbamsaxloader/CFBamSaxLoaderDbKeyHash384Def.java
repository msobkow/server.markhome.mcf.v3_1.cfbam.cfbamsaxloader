...
// Description: Java 25 XML SAX Element Handler for DbKeyHash384Def
...
/*
 *	CFBamSaxLoaderDbKeyHash384DefParse XML SAX Element Handler implementation
 *	for DbKeyHash384Def.
 */
public class CFBamSaxLoaderDbKeyHash384Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash384Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash384DefObj origBuff = null;
		ICFBamDbKeyHash384DefEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash384Def" );
			...
			origBuff = (ICFBamDbKeyHash384DefObj)schemaObj.getDbKeyHash384DefTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash384DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash384DefLoaderBehaviour();
			ICFBamDbKeyHash384DefEditObj editDbKeyHash384Def = null;
			ICFBamDbKeyHash384DefObj origDbKeyHash384Def = (ICFBamDbKeyHash384DefObj)schemaObj.getDbKeyHash384DefTableObj().readDbKeyHash384DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash384Def == null ) {
				editDbKeyHash384Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash384Def = (ICFBamDbKeyHash384DefEditObj)origDbKeyHash384Def.beginEdit();
						editDbKeyHash384Def.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash384Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash384Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash384Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash384Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash384Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash384Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash384Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash384Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash384Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash384Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash384Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash384Def = (ICFBamDbKeyHash384DefEditObj)origDbKeyHash384Def.beginEdit();
						editDbKeyHash384Def.deleteInstance();
						editDbKeyHash384Def = null;
						origDbKeyHash384Def = null;
						editDbKeyHash384Def = editBuff;
						break;
				}
			}

			if( editDbKeyHash384Def != null ) {
				if( origDbKeyHash384Def != null ) {
					editDbKeyHash384Def.update();
				}
				else {
					origDbKeyHash384Def = (ICFBamDbKeyHash384DefObj)editDbKeyHash384Def.create();
				}
				editDbKeyHash384Def = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash384Def );
		}
