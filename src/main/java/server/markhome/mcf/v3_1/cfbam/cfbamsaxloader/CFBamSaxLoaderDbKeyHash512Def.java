...
// Description: Java 25 XML SAX Element Handler for DbKeyHash512Def
...
/*
 *	CFBamSaxLoaderDbKeyHash512DefParse XML SAX Element Handler implementation
 *	for DbKeyHash512Def.
 */
public class CFBamSaxLoaderDbKeyHash512Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash512Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash512DefObj origBuff = null;
		ICFBamDbKeyHash512DefEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash512Def" );
			...
			origBuff = (ICFBamDbKeyHash512DefObj)schemaObj.getDbKeyHash512DefTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash512DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash512DefLoaderBehaviour();
			ICFBamDbKeyHash512DefEditObj editDbKeyHash512Def = null;
			ICFBamDbKeyHash512DefObj origDbKeyHash512Def = (ICFBamDbKeyHash512DefObj)schemaObj.getDbKeyHash512DefTableObj().readDbKeyHash512DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash512Def == null ) {
				editDbKeyHash512Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash512Def = (ICFBamDbKeyHash512DefEditObj)origDbKeyHash512Def.beginEdit();
						editDbKeyHash512Def.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash512Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash512Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash512Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash512Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash512Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash512Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash512Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash512Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash512Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash512Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash512Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash512Def = (ICFBamDbKeyHash512DefEditObj)origDbKeyHash512Def.beginEdit();
						editDbKeyHash512Def.deleteInstance();
						editDbKeyHash512Def = null;
						origDbKeyHash512Def = null;
						editDbKeyHash512Def = editBuff;
						break;
				}
			}

			if( editDbKeyHash512Def != null ) {
				if( origDbKeyHash512Def != null ) {
					editDbKeyHash512Def.update();
				}
				else {
					origDbKeyHash512Def = (ICFBamDbKeyHash512DefObj)editDbKeyHash512Def.create();
				}
				editDbKeyHash512Def = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash512Def );
		}
