...
// Description: Java 25 XML SAX Element Handler for DoubleCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDoubleColObj origBuff = null;
		ICFBamDoubleColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDoubleColObj)schemaObj.getDoubleColTableObj().newInstance();
			editBuff = (ICFBamDoubleColEditObj)origBuff.beginEdit();
			...
			ICFBamDoubleColObj origDoubleCol = (ICFBamDoubleColObj)schemaObj.getDoubleColTableObj().readDoubleColByUNameIdx( refScope.getRequiredId(),
			...
			if( origDoubleCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDoubleCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
