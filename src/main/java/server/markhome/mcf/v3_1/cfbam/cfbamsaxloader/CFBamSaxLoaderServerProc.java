...
// Description: Java 25 XML SAX Element Handler for ServerProc
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamServerProcObj origServerProc = (ICFBamServerProcObj)schemaObj.getServerProcTableObj().readServerProcByUNameIdx( refForTable.getRequiredId(),
