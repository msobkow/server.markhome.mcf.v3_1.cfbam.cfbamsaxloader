...
// Description: Java 25 XML SAX Element Handler for TZTimestampCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimestampColObj origBuff = null;
		ICFBamTZTimestampColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimestampColObj)schemaObj.getTZTimestampColTableObj().newInstance();
			editBuff = (ICFBamTZTimestampColEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimestampColObj origTZTimestampCol = (ICFBamTZTimestampColObj)schemaObj.getTZTimestampColTableObj().readTZTimestampColByUNameIdx( refScope.getRequiredId(),
