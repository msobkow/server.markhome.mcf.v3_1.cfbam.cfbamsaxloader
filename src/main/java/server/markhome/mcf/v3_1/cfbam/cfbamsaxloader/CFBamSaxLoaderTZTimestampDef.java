...
// Description: Java 25 XML SAX Element Handler for TZTimestampDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZTimestampDefObj origBuff = null;
		ICFBamTZTimestampDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZTimestampDefObj)schemaObj.getTZTimestampDefTableObj().newInstance();
			editBuff = (ICFBamTZTimestampDefEditObj)origBuff.beginEdit();
			...
			ICFBamTZTimestampDefObj origTZTimestampDef = (ICFBamTZTimestampDefObj)schemaObj.getTZTimestampDefTableObj().readTZTimestampDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZTimestampDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimestampDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
