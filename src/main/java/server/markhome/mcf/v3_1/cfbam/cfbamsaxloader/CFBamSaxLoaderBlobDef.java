...
// Description: Java 25 XML SAX Element Handler for BlobDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamBlobDefObj origBuff = null;
		ICFBamBlobDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamBlobDefObj)schemaObj.getBlobDefTableObj().newInstance();
			editBuff = (ICFBamBlobDefEditObj)origBuff.beginEdit();
			...
			ICFBamBlobDefObj origBlobDef = (ICFBamBlobDefObj)schemaObj.getBlobDefTableObj().readBlobDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origBlobDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
