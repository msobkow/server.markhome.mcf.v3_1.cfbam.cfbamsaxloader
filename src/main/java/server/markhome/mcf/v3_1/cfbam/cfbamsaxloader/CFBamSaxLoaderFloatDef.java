...
// Description: Java 25 XML SAX Element Handler for FloatDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamFloatDefObj origBuff = null;
		ICFBamFloatDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamFloatDefObj)schemaObj.getFloatDefTableObj().newInstance();
			editBuff = (ICFBamFloatDefEditObj)origBuff.beginEdit();
			...
			ICFBamFloatDefObj origFloatDef = (ICFBamFloatDefObj)schemaObj.getFloatDefTableObj().readFloatDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origFloatDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
