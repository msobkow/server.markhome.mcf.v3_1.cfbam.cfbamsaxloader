...
// Description: Java 25 XML SAX Element Handler for TZDateCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZDateColObj origBuff = null;
		ICFBamTZDateColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZDateColObj)schemaObj.getTZDateColTableObj().newInstance();
			editBuff = (ICFBamTZDateColEditObj)origBuff.beginEdit();
			...
			ICFBamTZDateColObj origTZDateCol = (ICFBamTZDateColObj)schemaObj.getTZDateColTableObj().readTZDateColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZDateCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
