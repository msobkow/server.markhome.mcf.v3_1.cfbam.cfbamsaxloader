...
// Description: Java 25 XML SAX Element Handler for TimestampDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimestampDefObj origBuff = null;
		ICFBamTimestampDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimestampDefObj)schemaObj.getTimestampDefTableObj().newInstance();
			editBuff = (ICFBamTimestampDefEditObj)origBuff.beginEdit();
			...
			ICFBamTimestampDefObj origTimestampDef = (ICFBamTimestampDefObj)schemaObj.getTimestampDefTableObj().readTimestampDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimestampDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimestampDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
