...
// Description: Java 25 XML SAX Element Handler for DbKeyHash128Type
...
/*
 *	CFBamSaxLoaderDbKeyHash128TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash128Type.
 */
public class CFBamSaxLoaderDbKeyHash128Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash128Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash128TypeObj origBuff = null;
		ICFBamDbKeyHash128TypeEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash128Type" );
			...
			origBuff = (ICFBamDbKeyHash128TypeObj)schemaObj.getDbKeyHash128TypeTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash128TypeEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash128TypeLoaderBehaviour();
			ICFBamDbKeyHash128TypeEditObj editDbKeyHash128Type = null;
			ICFBamDbKeyHash128TypeObj origDbKeyHash128Type = (ICFBamDbKeyHash128TypeObj)schemaObj.getDbKeyHash128TypeTableObj().readDbKeyHash128TypeByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash128Type == null ) {
				editDbKeyHash128Type = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash128Type = (ICFBamDbKeyHash128TypeEditObj)origDbKeyHash128Type.beginEdit();
						editDbKeyHash128Type.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash128Type.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash128Type.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash128Type.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash128Type.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash128Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash128Type.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash128Type.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash128Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash128Type.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash128Type.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash128Type.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash128Type = (ICFBamDbKeyHash128TypeEditObj)origDbKeyHash128Type.beginEdit();
						editDbKeyHash128Type.deleteInstance();
						editDbKeyHash128Type = null;
						origDbKeyHash128Type = null;
						editDbKeyHash128Type = editBuff;
						break;
				}
			}

			if( editDbKeyHash128Type != null ) {
				if( origDbKeyHash128Type != null ) {
					editDbKeyHash128Type.update();
				}
				else {
					origDbKeyHash128Type = (ICFBamDbKeyHash128TypeObj)editDbKeyHash128Type.create();
				}
				editDbKeyHash128Type = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash128Type );
		}
