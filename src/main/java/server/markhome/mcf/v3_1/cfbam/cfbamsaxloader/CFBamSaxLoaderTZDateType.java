...
// Description: Java 25 XML SAX Element Handler for TZDateType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZDateTypeObj origBuff = null;
		ICFBamTZDateTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZDateTypeObj)schemaObj.getTZDateTypeTableObj().newInstance();
			editBuff = (ICFBamTZDateTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTZDateTypeObj origTZDateType = (ICFBamTZDateTypeObj)schemaObj.getTZDateTypeTableObj().readTZDateTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZDateType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
