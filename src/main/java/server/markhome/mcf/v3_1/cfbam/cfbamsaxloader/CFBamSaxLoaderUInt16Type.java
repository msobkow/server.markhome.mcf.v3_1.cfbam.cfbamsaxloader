...
// Description: Java 25 XML SAX Element Handler for UInt16Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt16TypeObj origBuff = null;
		ICFBamUInt16TypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt16TypeObj)schemaObj.getUInt16TypeTableObj().newInstance();
			editBuff = (ICFBamUInt16TypeEditObj)origBuff.beginEdit();
			...
			ICFBamUInt16TypeObj origUInt16Type = (ICFBamUInt16TypeObj)schemaObj.getUInt16TypeTableObj().readUInt16TypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origUInt16Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
