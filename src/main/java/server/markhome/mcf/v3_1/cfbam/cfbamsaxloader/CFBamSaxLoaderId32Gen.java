...
// Description: Java 25 XML SAX Element Handler for Id32Gen
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamId32GenObj origBuff = null;
		ICFBamId32GenEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamId32GenObj)schemaObj.getId32GenTableObj().newInstance();
			editBuff = (ICFBamId32GenEditObj)origBuff.beginEdit();
			...
			ICFBamId32GenObj origId32Gen = (ICFBamId32GenObj)schemaObj.getId32GenTableObj().readId32GenByUNameIdx( refScope.getRequiredId(),
