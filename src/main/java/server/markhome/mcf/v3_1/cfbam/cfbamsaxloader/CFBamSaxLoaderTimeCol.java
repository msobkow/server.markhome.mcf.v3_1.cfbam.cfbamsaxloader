...
// Description: Java 25 XML SAX Element Handler for TimeCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimeColObj origBuff = null;
		ICFBamTimeColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimeColObj)schemaObj.getTimeColTableObj().newInstance();
			editBuff = (ICFBamTimeColEditObj)origBuff.beginEdit();
			...
			ICFBamTimeColObj origTimeCol = (ICFBamTimeColObj)schemaObj.getTimeColTableObj().readTimeColByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimeCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
