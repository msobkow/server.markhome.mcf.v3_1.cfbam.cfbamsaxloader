...
// Description: Java 25 XML SAX Element Handler for UInt16Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt16ColObj origBuff = null;
		ICFBamUInt16ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt16ColObj)schemaObj.getUInt16ColTableObj().newInstance();
			editBuff = (ICFBamUInt16ColEditObj)origBuff.beginEdit();
			...
			ICFBamUInt16ColObj origUInt16Col = (ICFBamUInt16ColObj)schemaObj.getUInt16ColTableObj().readUInt16ColByUNameIdx( refScope.getRequiredId(),
			...
			if( origUInt16Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
