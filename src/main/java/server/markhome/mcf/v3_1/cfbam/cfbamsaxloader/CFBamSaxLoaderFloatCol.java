...
// Description: Java 25 XML SAX Element Handler for FloatCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamFloatColObj origBuff = null;
		ICFBamFloatColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamFloatColObj)schemaObj.getFloatColTableObj().newInstance();
			editBuff = (ICFBamFloatColEditObj)origBuff.beginEdit();
			...
			ICFBamFloatColObj origFloatCol = (ICFBamFloatColObj)schemaObj.getFloatColTableObj().readFloatColByUNameIdx( refScope.getRequiredId(),
			...
			if( origFloatCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
