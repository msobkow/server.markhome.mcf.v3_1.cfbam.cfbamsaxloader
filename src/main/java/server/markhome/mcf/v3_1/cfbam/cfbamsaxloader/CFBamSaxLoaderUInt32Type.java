...
// Description: Java 25 XML SAX Element Handler for UInt32Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamUInt32TypeObj origUInt32Type = (ICFBamUInt32TypeObj)schemaObj.getUInt32TypeTableObj().readUInt32TypeByUNameIdx( refScope.getRequiredId(),
