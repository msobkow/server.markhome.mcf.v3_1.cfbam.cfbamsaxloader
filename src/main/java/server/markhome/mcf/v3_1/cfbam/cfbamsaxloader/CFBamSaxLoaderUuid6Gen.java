...
// Description: Java 25 XML SAX Element Handler for Uuid6Gen
...
/*
 *	CFBamSaxLoaderUuid6GenParse XML SAX Element Handler implementation
 *	for Uuid6Gen.
 */
public class CFBamSaxLoaderUuid6Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuid6Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamUuid6GenObj origBuff = null;
		ICFBamUuid6GenEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuid6GenObj)schemaObj.getUuid6GenTableObj().newInstance();
			editBuff = (ICFBamUuid6GenEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getUuid6GenLoaderBehaviour();
			ICFBamUuid6GenEditObj editUuid6Gen = null;
			ICFBamUuid6GenObj origUuid6Gen = (ICFBamUuid6GenObj)schemaObj.getUuid6GenTableObj().readUuid6GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origUuid6Gen == null ) {
				editUuid6Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editUuid6Gen = (ICFBamUuid6GenEditObj)origUuid6Gen.beginEdit();
						editUuid6Gen.setRequiredName( editBuff.getRequiredName() );
						editUuid6Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editUuid6Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editUuid6Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editUuid6Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editUuid6Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editUuid6Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editUuid6Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editUuid6Gen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editUuid6Gen.setOptionalDbName( editBuff.getOptionalDbName() );
						editUuid6Gen.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editUuid6Gen.setRequiredSlice( editBuff.getRequiredSlice() );
						editUuid6Gen.setRequiredBlockSize( editBuff.getRequiredBlockSize() );
						editUuid6Gen.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editUuid6Gen = (ICFBamUuid6GenEditObj)origUuid6Gen.beginEdit();
						editUuid6Gen.deleteInstance();
						editUuid6Gen = null;
						origUuid6Gen = null;
						editUuid6Gen = editBuff;
						break;
			...
			if( editUuid6Gen != null ) {
				if( origUuid6Gen != null ) {
					editUuid6Gen.update();
				}
				else {
					origUuid6Gen = (ICFBamUuid6GenObj)editUuid6Gen.create();
				}
				editUuid6Gen = null;
			}

			curContext.putNamedValue( "Object", origUuid6Gen );
		}
