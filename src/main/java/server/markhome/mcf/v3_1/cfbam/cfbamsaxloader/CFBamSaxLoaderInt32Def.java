...
// Description: Java 25 XML SAX Element Handler for Int32Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt32DefObj origBuff = null;
		ICFBamInt32DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt32DefObj)schemaObj.getInt32DefTableObj().newInstance();
			editBuff = (ICFBamInt32DefEditObj)origBuff.beginEdit();
			...
			ICFBamInt32DefObj origInt32Def = (ICFBamInt32DefObj)schemaObj.getInt32DefTableObj().readInt32DefByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt32Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt32Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
