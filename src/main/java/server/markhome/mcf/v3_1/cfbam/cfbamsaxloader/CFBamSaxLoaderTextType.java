...
// Description: Java 25 XML SAX Element Handler for TextType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTextTypeObj origBuff = null;
		ICFBamTextTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTextTypeObj)schemaObj.getTextTypeTableObj().newInstance();
			editBuff = (ICFBamTextTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTextTypeObj origTextType = (ICFBamTextTypeObj)schemaObj.getTextTypeTableObj().readTextTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTextType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
