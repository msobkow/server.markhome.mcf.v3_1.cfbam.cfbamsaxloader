...
// Description: Java 25 XML SAX Element Handler for DelTopDep
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDelTopDepObj origBuff = null;
		ICFBamDelTopDepEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDelTopDepObj)schemaObj.getDelTopDepTableObj().newInstance();
			editBuff = (ICFBamDelTopDepEditObj)origBuff.beginEdit();
