...
// Description: Java 25 XML SAX Element Handler for DbKeyHash128Def
...
/*
 *	CFBamSaxLoaderDbKeyHash128DefParse XML SAX Element Handler implementation
 *	for DbKeyHash128Def.
 */
public class CFBamSaxLoaderDbKeyHash128Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash128Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash128DefObj origBuff = null;
		ICFBamDbKeyHash128DefEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash128Def" );
			...
			origBuff = (ICFBamDbKeyHash128DefObj)schemaObj.getDbKeyHash128DefTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash128DefEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash128DefLoaderBehaviour();
			ICFBamDbKeyHash128DefEditObj editDbKeyHash128Def = null;
			ICFBamDbKeyHash128DefObj origDbKeyHash128Def = (ICFBamDbKeyHash128DefObj)schemaObj.getDbKeyHash128DefTableObj().readDbKeyHash128DefByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash128Def == null ) {
				editDbKeyHash128Def = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash128Def = (ICFBamDbKeyHash128DefEditObj)origDbKeyHash128Def.beginEdit();
						editDbKeyHash128Def.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash128Def.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash128Def.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash128Def.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash128Def.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash128Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash128Def.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash128Def.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash128Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash128Def.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash128Def.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash128Def.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash128Def = (ICFBamDbKeyHash128DefEditObj)origDbKeyHash128Def.beginEdit();
						editDbKeyHash128Def.deleteInstance();
						editDbKeyHash128Def = null;
						origDbKeyHash128Def = null;
						editDbKeyHash128Def = editBuff;
						break;
				}
			}

			if( editDbKeyHash128Def != null ) {
				if( origDbKeyHash128Def != null ) {
					editDbKeyHash128Def.update();
				}
				else {
					origDbKeyHash128Def = (ICFBamDbKeyHash128DefObj)editDbKeyHash128Def.create();
				}
				editDbKeyHash128Def = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash128Def );
		}
