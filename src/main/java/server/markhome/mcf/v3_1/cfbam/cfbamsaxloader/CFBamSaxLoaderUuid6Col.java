...
// Description: Java 25 XML SAX Element Handler for Uuid6Col
...
/*
 *	CFBamSaxLoaderUuid6ColParse XML SAX Element Handler implementation
 *	for Uuid6Col.
 */
public class CFBamSaxLoaderUuid6Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuid6Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamUuid6ColObj origBuff = null;
		ICFBamUuid6ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuid6ColObj)schemaObj.getUuid6ColTableObj().newInstance();
			editBuff = (ICFBamUuid6ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getUuid6ColLoaderBehaviour();
			ICFBamUuid6ColEditObj editUuid6Col = null;
			ICFBamUuid6ColObj origUuid6Col = (ICFBamUuid6ColObj)schemaObj.getUuid6ColTableObj().readUuid6ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origUuid6Col == null ) {
				editUuid6Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editUuid6Col = (ICFBamUuid6ColEditObj)origUuid6Col.beginEdit();
						editUuid6Col.setRequiredName( editBuff.getRequiredName() );
						editUuid6Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editUuid6Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editUuid6Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editUuid6Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editUuid6Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editUuid6Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editUuid6Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editUuid6Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editUuid6Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editUuid6Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editUuid6Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editUuid6Col = (ICFBamUuid6ColEditObj)origUuid6Col.beginEdit();
						editUuid6Col.deleteInstance();
						editUuid6Col = null;
						origUuid6Col = null;
						editUuid6Col = editBuff;
						break;
			...
			if( editUuid6Col != null ) {
				if( origUuid6Col != null ) {
					editUuid6Col.update();
				}
				else {
					origUuid6Col = (ICFBamUuid6ColObj)editUuid6Col.create();
				}
				editUuid6Col = null;
			}

			curContext.putNamedValue( "Object", origUuid6Col );
		}
