...
// Description: Java 25 XML SAX Element Handler for NmTokensCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamNmTokensColObj origBuff = null;
		ICFBamNmTokensColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamNmTokensColObj)schemaObj.getNmTokensColTableObj().newInstance();
			editBuff = (ICFBamNmTokensColEditObj)origBuff.beginEdit();
			...
			ICFBamNmTokensColObj origNmTokensCol = (ICFBamNmTokensColObj)schemaObj.getNmTokensColTableObj().readNmTokensColByUNameIdx( refScope.getRequiredId(),
			...
			if( origNmTokensCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
