...
// Description: Java 25 XML SAX Element Handler for UuidCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUuidColObj origBuff = null;
		ICFBamUuidColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuidColObj)schemaObj.getUuidColTableObj().newInstance();
			editBuff = (ICFBamUuidColEditObj)origBuff.beginEdit();
			...
			ICFBamUuidColObj origUuidCol = (ICFBamUuidColObj)schemaObj.getUuidColTableObj().readUuidColByUNameIdx( refScope.getRequiredId(),
			...
			if( origUuidCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
