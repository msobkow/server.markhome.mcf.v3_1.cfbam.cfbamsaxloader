...
// Description: Java 25 XML SAX Element Handler for ClearSubDep1
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamClearSubDep1Obj origBuff = null;
		ICFBamClearSubDep1EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamClearSubDep1Obj)schemaObj.getClearSubDep1TableObj().newInstance();
			editBuff = (ICFBamClearSubDep1EditObj)origBuff.beginEdit();
