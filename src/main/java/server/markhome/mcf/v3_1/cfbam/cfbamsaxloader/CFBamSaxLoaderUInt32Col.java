...
// Description: Java 25 XML SAX Element Handler for UInt32Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt32ColObj origBuff = null;
		ICFBamUInt32ColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt32ColObj)schemaObj.getUInt32ColTableObj().newInstance();
			editBuff = (ICFBamUInt32ColEditObj)origBuff.beginEdit();
			...
			ICFBamUInt32ColObj origUInt32Col = (ICFBamUInt32ColObj)schemaObj.getUInt32ColTableObj().readUInt32ColByUNameIdx( refScope.getRequiredId(),
			...
			if( origUInt32Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt32Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
