...
// Description: Java 25 XML SAX Element Handler for DbKeyHash256Gen
...
/*
 *	CFBamSaxLoaderDbKeyHash256GenParse XML SAX Element Handler implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamSaxLoaderDbKeyHash256Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash256Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash256GenObj origBuff = null;
		ICFBamDbKeyHash256GenEditObj editBuff = null;
		...
		try {
			assert qName.equals( "DbKeyHash256Gen" );
			...
			origBuff = (ICFBamDbKeyHash256GenObj)schemaObj.getDbKeyHash256GenTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash256GenEditObj)origBuff.beginEdit();
			...
			ICFBamDbKeyHash256GenObj origDbKeyHash256Gen = (ICFBamDbKeyHash256GenObj)schemaObj.getDbKeyHash256GenTableObj().readDbKeyHash256GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash256Gen == null ) {
				editDbKeyHash256Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash256Gen.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash256Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash256Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash256Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash256Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash256Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash256Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash256Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
					...
					case Replace:
						editDbKeyHash256Gen = (ICFBamDbKeyHash256GenEditObj)origDbKeyHash256Gen.beginEdit();
						editDbKeyHash256Gen.deleteInstance();
						editDbKeyHash256Gen = null;
						origDbKeyHash256Gen = null;
						editDbKeyHash256Gen = editBuff;
						break;
				}
			}

			if( editDbKeyHash256Gen != null ) {
				if( origDbKeyHash256Gen != null ) {
					editDbKeyHash256Gen.update();
				}
				else {
					origDbKeyHash256Gen = (ICFBamDbKeyHash256GenObj)editDbKeyHash256Gen.create();
				}
				editDbKeyHash256Gen = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash256Gen );
		}
