...
// Description: Java 25 XML SAX Element Handler for ClearDep
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamClearDepObj origBuff = null;
		ICFBamClearDepEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamClearDepObj)schemaObj.getClearDepTableObj().newInstance();
			editBuff = (ICFBamClearDepEditObj)origBuff.beginEdit();
