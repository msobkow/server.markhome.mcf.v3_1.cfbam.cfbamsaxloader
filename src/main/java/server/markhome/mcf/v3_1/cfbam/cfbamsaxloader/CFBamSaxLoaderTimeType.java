...
// Description: Java 25 XML SAX Element Handler for TimeType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimeTypeObj origBuff = null;
		ICFBamTimeTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimeTypeObj)schemaObj.getTimeTypeTableObj().newInstance();
			editBuff = (ICFBamTimeTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTimeTypeObj origTimeType = (ICFBamTimeTypeObj)schemaObj.getTimeTypeTableObj().readTimeTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimeType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
