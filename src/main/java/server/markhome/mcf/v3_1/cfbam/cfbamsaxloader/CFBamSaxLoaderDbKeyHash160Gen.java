...
// Description: Java 25 XML SAX Element Handler for DbKeyHash160Gen
...
/*
 *	CFBamSaxLoaderDbKeyHash160GenParse XML SAX Element Handler implementation
 *	for DbKeyHash160Gen.
 */
public class CFBamSaxLoaderDbKeyHash160Gen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash160Gen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash160GenObj origBuff = null;
		ICFBamDbKeyHash160GenEditObj editBuff = null;
		...
		// DbKeyHash160Gen Attributes
		String attrSlice = null;
		String attrBlockSize = null;
		// DbKeyHash160Gen References
		...
		try {
			assert qName.equals( "DbKeyHash160Gen" );
			...
			origBuff = (ICFBamDbKeyHash160GenObj)schemaObj.getDbKeyHash160GenTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash160GenEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash160GenLoaderBehaviour();
			ICFBamDbKeyHash160GenEditObj editDbKeyHash160Gen = null;
			ICFBamDbKeyHash160GenObj origDbKeyHash160Gen = (ICFBamDbKeyHash160GenObj)schemaObj.getDbKeyHash160GenTableObj().readDbKeyHash160GenByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash160Gen == null ) {
				editDbKeyHash160Gen = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash160Gen = (ICFBamDbKeyHash160GenEditObj)origDbKeyHash160Gen.beginEdit();
						editDbKeyHash160Gen.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash160Gen.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash160Gen.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash160Gen.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash160Gen.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash160Gen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash160Gen.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash160Gen.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash160Gen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash160Gen.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash160Gen.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash160Gen.setRequiredSlice( editBuff.getRequiredSlice() );
						editDbKeyHash160Gen.setRequiredBlockSize( editBuff.getRequiredBlockSize() );
						editDbKeyHash160Gen.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash160Gen = (ICFBamDbKeyHash160GenEditObj)origDbKeyHash160Gen.beginEdit();
						editDbKeyHash160Gen.deleteInstance();
						editDbKeyHash160Gen = null;
						origDbKeyHash160Gen = null;
						editDbKeyHash160Gen = editBuff;
						break;
				}
			}

			if( editDbKeyHash160Gen != null ) {
				if( origDbKeyHash160Gen != null ) {
					editDbKeyHash160Gen.update();
				}
				else {
					origDbKeyHash160Gen = (ICFBamDbKeyHash160GenObj)editDbKeyHash160Gen.create();
				}
				editDbKeyHash160Gen = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash160Gen );
		}
