...
// Description: Java 25 XML SAX Element Handler for BoolDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamBoolDefObj origBoolDef = (ICFBamBoolDefObj)schemaObj.getBoolDefTableObj().readBoolDefByUNameIdx( refScope.getRequiredId(),
