...
// Description: Java 25 XML SAX Element Handler for DelDep
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDelDepObj origBuff = null;
		ICFBamDelDepEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDelDepObj)schemaObj.getDelDepTableObj().newInstance();
			editBuff = (ICFBamDelDepEditObj)origBuff.beginEdit();
