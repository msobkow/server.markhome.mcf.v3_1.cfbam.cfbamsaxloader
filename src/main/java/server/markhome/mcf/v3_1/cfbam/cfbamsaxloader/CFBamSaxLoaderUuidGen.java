...
// Description: Java 25 XML SAX Element Handler for UuidGen
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUuidGenObj origBuff = null;
		ICFBamUuidGenEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuidGenObj)schemaObj.getUuidGenTableObj().newInstance();
			editBuff = (ICFBamUuidGenEditObj)origBuff.beginEdit();
			...
			ICFBamUuidGenObj origUuidGen = (ICFBamUuidGenObj)schemaObj.getUuidGenTableObj().readUuidGenByUNameIdx( refScope.getRequiredId(),
			...
			if( origUuidGen == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidGen.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
