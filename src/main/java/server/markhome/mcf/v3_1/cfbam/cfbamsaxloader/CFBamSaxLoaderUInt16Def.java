...
// Description: Java 25 XML SAX Element Handler for UInt16Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt16DefObj origBuff = null;
		ICFBamUInt16DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt16DefObj)schemaObj.getUInt16DefTableObj().newInstance();
			editBuff = (ICFBamUInt16DefEditObj)origBuff.beginEdit();
			...
			ICFBamUInt16DefObj origUInt16Def = (ICFBamUInt16DefObj)schemaObj.getUInt16DefTableObj().readUInt16DefByUNameIdx( refScope.getRequiredId(),
			...
			if( origUInt16Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
