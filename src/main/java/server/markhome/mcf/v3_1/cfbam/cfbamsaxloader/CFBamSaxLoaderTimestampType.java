...
// Description: Java 25 XML SAX Element Handler for TimestampType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTimestampTypeObj origBuff = null;
		ICFBamTimestampTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTimestampTypeObj)schemaObj.getTimestampTypeTableObj().newInstance();
			editBuff = (ICFBamTimestampTypeEditObj)origBuff.beginEdit();
			...
			ICFBamTimestampTypeObj origTimestampType = (ICFBamTimestampTypeObj)schemaObj.getTimestampTypeTableObj().readTimestampTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origTimestampType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimestampType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
