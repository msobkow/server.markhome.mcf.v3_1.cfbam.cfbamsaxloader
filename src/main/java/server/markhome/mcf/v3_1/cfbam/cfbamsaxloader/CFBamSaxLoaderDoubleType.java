...
// Description: Java 25 XML SAX Element Handler for DoubleType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDoubleTypeObj origBuff = null;
		ICFBamDoubleTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDoubleTypeObj)schemaObj.getDoubleTypeTableObj().newInstance();
			editBuff = (ICFBamDoubleTypeEditObj)origBuff.beginEdit();
			...
			ICFBamDoubleTypeObj origDoubleType = (ICFBamDoubleTypeObj)schemaObj.getDoubleTypeTableObj().readDoubleTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origDoubleType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDoubleType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
