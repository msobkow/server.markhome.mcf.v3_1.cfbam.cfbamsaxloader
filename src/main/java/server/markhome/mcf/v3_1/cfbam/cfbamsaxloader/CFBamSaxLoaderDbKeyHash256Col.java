...
// Description: Java 25 XML SAX Element Handler for DbKeyHash256Col
...
/*
 *	CFBamSaxLoaderDbKeyHash256ColParse XML SAX Element Handler implementation
 *	for DbKeyHash256Col.
 */
public class CFBamSaxLoaderDbKeyHash256Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash256Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash256ColObj origBuff = null;
		ICFBamDbKeyHash256ColEditObj editBuff = null;
		...
		// DbKeyHash256Col Attributes
		// DbKeyHash256Col References
		...
		try {
			assert qName.equals( "DbKeyHash256Col" );
			...
			origBuff = (ICFBamDbKeyHash256ColObj)schemaObj.getDbKeyHash256ColTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash256ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash256ColLoaderBehaviour();
			ICFBamDbKeyHash256ColEditObj editDbKeyHash256Col = null;
			ICFBamDbKeyHash256ColObj origDbKeyHash256Col = (ICFBamDbKeyHash256ColObj)schemaObj.getDbKeyHash256ColTableObj().readDbKeyHash256ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash256Col == null ) {
				editDbKeyHash256Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash256Col = (ICFBamDbKeyHash256ColEditObj)origDbKeyHash256Col.beginEdit();
						editDbKeyHash256Col.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash256Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash256Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash256Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash256Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash256Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash256Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash256Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash256Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash256Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash256Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash256Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash256Col = (ICFBamDbKeyHash256ColEditObj)origDbKeyHash256Col.beginEdit();
						editDbKeyHash256Col.deleteInstance();
						editDbKeyHash256Col = null;
						origDbKeyHash256Col = null;
						editDbKeyHash256Col = editBuff;
						break;
				}
			}

			if( editDbKeyHash256Col != null ) {
				if( origDbKeyHash256Col != null ) {
					editDbKeyHash256Col.update();
				}
				else {
					origDbKeyHash256Col = (ICFBamDbKeyHash256ColObj)editDbKeyHash256Col.create();
				}
				editDbKeyHash256Col = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash256Col );
		}
