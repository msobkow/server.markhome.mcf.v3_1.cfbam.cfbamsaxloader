...
// Description: Java 25 XML SAX Element Handler for DbKeyHash224Col
...
/*
 *	CFBamSaxLoaderDbKeyHash224ColParse XML SAX Element Handler implementation
 *	for DbKeyHash224Col.
 */
public class CFBamSaxLoaderDbKeyHash224Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDbKeyHash224Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamDbKeyHash224ColObj origBuff = null;
		ICFBamDbKeyHash224ColEditObj editBuff = null;
		...
		// DbKeyHash224Col Attributes
		// DbKeyHash224Col References
		...
		try {
			assert qName.equals( "DbKeyHash224Col" );
			...
			origBuff = (ICFBamDbKeyHash224ColObj)schemaObj.getDbKeyHash224ColTableObj().newInstance();
			editBuff = (ICFBamDbKeyHash224ColEditObj)origBuff.beginEdit();
			...
			CFBamSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getDbKeyHash224ColLoaderBehaviour();
			ICFBamDbKeyHash224ColEditObj editDbKeyHash224Col = null;
			ICFBamDbKeyHash224ColObj origDbKeyHash224Col = (ICFBamDbKeyHash224ColObj)schemaObj.getDbKeyHash224ColTableObj().readDbKeyHash224ColByUNameIdx( refScope.getRequiredId(),
			editBuff.getRequiredName() );
			if( origDbKeyHash224Col == null ) {
				editDbKeyHash224Col = editBuff;
			}
			else {
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editDbKeyHash224Col = (ICFBamDbKeyHash224ColEditObj)origDbKeyHash224Col.beginEdit();
						editDbKeyHash224Col.setRequiredName( editBuff.getRequiredName() );
						editDbKeyHash224Col.setOptionalShortName( editBuff.getOptionalShortName() );
						editDbKeyHash224Col.setOptionalLabel( editBuff.getOptionalLabel() );
						editDbKeyHash224Col.setOptionalShortDescription( editBuff.getOptionalShortDescription() );
						editDbKeyHash224Col.setOptionalDescription( editBuff.getOptionalDescription() );
						editDbKeyHash224Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						editDbKeyHash224Col.setRequiredIsNullable( editBuff.getRequiredIsNullable() );
						editDbKeyHash224Col.setOptionalGenerateId( editBuff.getOptionalGenerateId() );
						editDbKeyHash224Col.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editDbKeyHash224Col.setOptionalDbName( editBuff.getOptionalDbName() );
						editDbKeyHash224Col.setOptionalInitValue( editBuff.getOptionalInitValue() );
						editDbKeyHash224Col.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDbKeyHash224Col = (ICFBamDbKeyHash224ColEditObj)origDbKeyHash224Col.beginEdit();
						editDbKeyHash224Col.deleteInstance();
						editDbKeyHash224Col = null;
						origDbKeyHash224Col = null;
						editDbKeyHash224Col = editBuff;
						break;
				}
			}

			if( editDbKeyHash224Col != null ) {
				if( origDbKeyHash224Col != null ) {
					editDbKeyHash224Col.update();
				}
				else {
					origDbKeyHash224Col = (ICFBamDbKeyHash224ColObj)editDbKeyHash224Col.create();
				}
				editDbKeyHash224Col = null;
			}

			curContext.putNamedValue( "Object", origDbKeyHash224Col );
		}
