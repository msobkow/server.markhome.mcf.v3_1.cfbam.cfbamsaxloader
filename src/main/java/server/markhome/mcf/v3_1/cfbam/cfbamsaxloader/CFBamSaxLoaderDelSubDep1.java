...
// Description: Java 25 XML SAX Element Handler for DelSubDep1
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDelSubDep1Obj origBuff = null;
		ICFBamDelSubDep1EditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDelSubDep1Obj)schemaObj.getDelSubDep1TableObj().newInstance();
			editBuff = (ICFBamDelSubDep1EditObj)origBuff.beginEdit();
