...
// Description: Java 25 XML SAX Element Handler for TZDateDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTZDateDefObj origBuff = null;
		ICFBamTZDateDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTZDateDefObj)schemaObj.getTZDateDefTableObj().newInstance();
			editBuff = (ICFBamTZDateDefEditObj)origBuff.beginEdit();
			...
			ICFBamTZDateDefObj origTZDateDef = (ICFBamTZDateDefObj)schemaObj.getTZDateDefTableObj().readTZDateDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTZDateDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
