...
// Description: Java 25 XML SAX Element Handler for StringCol
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamStringColObj origBuff = null;
		ICFBamStringColEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamStringColObj)schemaObj.getStringColTableObj().newInstance();
			editBuff = (ICFBamStringColEditObj)origBuff.beginEdit();
			...
			curContext.putNamedValue( "IsPolymorph", attrIsPolymorph );
			...
			if( attrIsPolymorph.equals( "true" ) || attrIsPolymorph.equals( "yes" ) || attrIsPolymorph.equals( "1" ) ) {
				...
				throw new CFLibUsageException( getClass(),
					S_ProcName,
					String.format(Inz.x("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsPolymorph", attrIsPolymorph),
					String.format(Inz.s("cflib.xml.CFLibXmlUtil.XmlBooleanInvalid"), "IsPolymorph", attrIsPolymorph));
			}
			...
			ICFBamStringColObj origStringCol = (ICFBamStringColObj)schemaObj.getStringColTableObj().readStringColByUNameIdx( refScope.getRequiredId(),
			...
			if( origStringCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editStringCol.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
						editStringCol.setOptionalDbName( editBuff.getOptionalDbName() );
						editStringCol.setRequiredMaxLen( editBuff.getRequiredMaxLen() );
						editStringCol.setRequiredIsPolymorph( editBuff.getRequiredIsPolymorph() );
