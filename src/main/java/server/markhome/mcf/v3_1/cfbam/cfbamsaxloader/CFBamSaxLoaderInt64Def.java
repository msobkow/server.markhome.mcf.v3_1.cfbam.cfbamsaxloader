...
// Description: Java 25 XML SAX Element Handler for Int64Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt64DefObj origBuff = null;
		ICFBamInt64DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt64DefObj)schemaObj.getInt64DefTableObj().newInstance();
			editBuff = (ICFBamInt64DefEditObj)origBuff.beginEdit();
			...
			ICFBamInt64DefObj origInt64Def = (ICFBamInt64DefObj)schemaObj.getInt64DefTableObj().readInt64DefByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt64Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt64Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
