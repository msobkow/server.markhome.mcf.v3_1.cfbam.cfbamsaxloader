...
// Description: Java 25 XML SAX Element Handler for Int32Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamInt32TypeObj origBuff = null;
		ICFBamInt32TypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamInt32TypeObj)schemaObj.getInt32TypeTableObj().newInstance();
			editBuff = (ICFBamInt32TypeEditObj)origBuff.beginEdit();
			...
			ICFBamInt32TypeObj origInt32Type = (ICFBamInt32TypeObj)schemaObj.getInt32TypeTableObj().readInt32TypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origInt32Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt32Type.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
