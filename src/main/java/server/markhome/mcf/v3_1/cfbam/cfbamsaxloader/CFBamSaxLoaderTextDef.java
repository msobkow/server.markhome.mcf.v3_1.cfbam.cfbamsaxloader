...
// Description: Java 25 XML SAX Element Handler for TextDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamTextDefObj origBuff = null;
		ICFBamTextDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTextDefObj)schemaObj.getTextDefTableObj().newInstance();
			editBuff = (ICFBamTextDefEditObj)origBuff.beginEdit();
			...
			ICFBamTextDefObj origTextDef = (ICFBamTextDefObj)schemaObj.getTextDefTableObj().readTextDefByUNameIdx( refScope.getRequiredId(),
			...
			if( origTextDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextDef.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
