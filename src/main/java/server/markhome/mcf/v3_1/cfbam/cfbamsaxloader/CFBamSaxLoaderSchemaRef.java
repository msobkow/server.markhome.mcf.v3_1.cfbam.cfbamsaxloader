...
// Description: Java 25 XML SAX Element Handler for SchemaRef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamSchemaRefObj origBuff = null;
		ICFBamSchemaRefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamSchemaRefObj)schemaObj.getSchemaRefTableObj().newInstance();
			editBuff = (ICFBamSchemaRefEditObj)origBuff.beginEdit();
