...
// Description: Java 25 XML SAX Element Handler for UuidType
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUuidTypeObj origBuff = null;
		ICFBamUuidTypeEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUuidTypeObj)schemaObj.getUuidTypeTableObj().newInstance();
			editBuff = (ICFBamUuidTypeEditObj)origBuff.beginEdit();
			...
			ICFBamUuidTypeObj origUuidType = (ICFBamUuidTypeObj)schemaObj.getUuidTypeTableObj().readUuidTypeByUNameIdx( refScope.getRequiredId(),
			...
			if( origUuidType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidType.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
