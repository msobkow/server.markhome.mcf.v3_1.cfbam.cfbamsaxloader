...
// Description: Java 25 XML SAX Element Handler for UInt32Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamUInt32DefObj origBuff = null;
		ICFBamUInt32DefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamUInt32DefObj)schemaObj.getUInt32DefTableObj().newInstance();
			editBuff = (ICFBamUInt32DefEditObj)origBuff.beginEdit();
			...
			ICFBamUInt32DefObj origUInt32Def = (ICFBamUInt32DefObj)schemaObj.getUInt32DefTableObj().readUInt32DefByUNameIdx( refScope.getRequiredId(),
			...
			if( origUInt32Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt32Def.setRequiredImplementsPolymorph( editBuff.getRequiredImplementsPolymorph() );
