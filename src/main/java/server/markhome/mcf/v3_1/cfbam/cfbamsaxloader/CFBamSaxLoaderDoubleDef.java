...
// Description: Java 25 XML SAX Element Handler for DoubleDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		ICFBamDoubleDefObj origBuff = null;
		ICFBamDoubleDefEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamDoubleDefObj)schemaObj.getDoubleDefTableObj().newInstance();
			editBuff = (ICFBamDoubleDefEditObj)origBuff.beginEdit();
			...
			ICFBamDoubleDefObj origDoubleDef = (ICFBamDoubleDefObj)schemaObj.getDoubleDefTableObj().readDoubleDefByUNameIdx( refScope.getRequiredId(),
